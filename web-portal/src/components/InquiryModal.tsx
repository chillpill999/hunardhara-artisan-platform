  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      saveInquiry({
        ...
        artisan_id: artisanId || '11111111-1111-1111-1111-111111111111',
        artisan_name: artisanName || 'राधेश्याम अंसारी (Radheshyam Ansari)',
        customer_name: customerName.trim(),
        customer_phone: customerPhone.trim(),
        customer_email: customerEmail.trim() || 'buyer@hunardhara.customer',
